  ...
  "ChirpPhaseNoiseSource": {
    ...
    "params": {
      ...
      "sampling_rate": {
        "type": "integer",
        "default": "10",
        "description": "frequency with which phase noise is sampled (Hz). If None, noise is sampled every timestep (default is 10 Hz)"
      }
    },
    "inputs": [],
    "outputs": [
  ...
  "Clip": {
    ...
    "params": {
      ...
      "max_val": {
        "type": "number",
        "default": "1.0",
        "description": "maximum clipping value"
      }
    },
    "inputs": [],
    "outputs": []
  ...
  "Pow": {
    ...
    "params": {
      "exponent": {
        "type": "integer",
        "default": "2",
        "description": "exponent to raise the input to the power of"
      }
    },
    "inputs": [],
    "outputs": []
